...
function Policy() {
  return (
    ...
    <div className="policy-container">
      ...
      <h2 className="h2-heading font-weight-bold mt-3">Terms and Conditions</h2>
    <ul>
        <li>
          <p className='mt-6'>Exclusions:</p>
          <ul>
        ...
        <li>
          <p>Hotel Policy:</p>
          <ul>
            <li>Standard check-in time at the hotel is normally 2:00 pm and check-out is 11:00 am.</li>
            <li>An early check-in, or a late check-out is solely based on the discretion of the hotel.</li>
        ...
        <li>
          <p>Itinerary:</p>
          <ul>
            <li>The itinerary is fixed and cannot be modified.</li>
            <li>Transportation shall be provided as per the itinerary and will not be at disposal.</li>
            <li>For any paid activity which is non-operational due to any unforeseen reason, we will process refund & same should reach the guest within 30 days of processing the refund.</li>
        ...
        <li>
          ...
          <ul>
            ...
            <li>Certain hotels may ask for a security deposit during check-in, which is refundable at check-out subject to the hotel policy.</li>
            ...
            <li>The package price does not include mandatory gala dinner charges levied by the hotels especially during New Year and Christmas or any special occasions. MakeMyTrip shall try to communicate the same while booking the package. However MakeMyTrip may not have this information readily available all the time.</li>
